...
- Автосинхронизация запускается WorkManager каждые 15 минут при наличии сети и принятом предупреждении.
...
- Автосинхронизация публичных конфигов выполняется не чаще одного раза в 15 минут и только при доступной сети.
